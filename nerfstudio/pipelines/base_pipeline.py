...
class VanillaPipeline(Pipeline):
    ...
    def __init__(
        ...
        self.datamanager: DataManager = config.datamanager.setup(
            device=device, test_mode=test_mode, world_size=world_size, local_rank=local_rank, train_images=train_images, train_poses=train_poses,
        )
    ...
    def update_pipeline_new_data(self, img_list, transforms_list):
        self.datamanager.update_train(img_list, transforms_list)
        self._model.update_embedding(num_images=len(self.datamanager.train_dataset))
