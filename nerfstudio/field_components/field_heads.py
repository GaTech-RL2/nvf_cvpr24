...
class RGBVarianceFieldHead(FieldHead):
    """RGB Uncertainty output
    ...
    """
    def __init__(self, in_dim: Optional[int] = None, activation: Optional[nn.Module] = nn.Softplus()) -> None:
        super().__init__(in_dim=in_dim, out_dim=3, field_head_name=FieldHeadNames.RGB_VARIANCE, activation=activation)
