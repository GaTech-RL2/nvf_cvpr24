...
from nerfstudio.models.neur_ar import NeurARModelConfig, NeurARModel
...
method_configs["neur_ar"] = TrainerConfig(
    method_name="neur_ar",
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=NeurARModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
