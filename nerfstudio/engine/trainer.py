...
class Trainer:
    ...
    def __init__(self, config: TrainerConfig, local_rank: int = 0, world_size: int = 1) -> None:
        ...
        self.viewer_on = False
        self.init_train = True

    def setup(self, test_mode: Literal["test", "val", "inference"] = "val", images = [], poses = []) -> None:
    ...
    def custom_setup(self, test_mode: Literal["test", "val", "inference"] = "val", images = [], poses = []) -> None:
        """Setup the Trainer by calling other setup functions.
    ...
    def custom_train(self, add_images = [], add_poses = []) -> None:
        """Train the model."""

        if len(add_images) > 0:
            self.images = add_images
            self.poses = add_poses 
    ...
    def _update_checkpoint(self) -> None:
        ...
        if load_dir is not None:
            ...
            if len(self.images) > 0:
                self.pipeline.update_pipeline_new_data(self.images, self.poses)
            # TEST
